           ...
           <>
            ...
            <View style={{ flex: 1, paddingTop: 40 }}>
                <ScrollView contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 20 }}>
                    ...
                    <View>
                        <Text onPress={() => navigation.navigate('resetpassword')}  regular style={{ color: Colors.brandColor, marginVertical: 20 }}>Reset Password</Text>
                    </View>
                    <View style={{ marginTop: 20 }}>
                    ...
                    <View style={{  marginVertical: 20 }}>
                        <Text onPress={() => navigation.navigate('signup')} regular style={{ textAlign: 'center'}}>New to Listiffy ? <Text light style={{ color: Colors.brandColor }}>Create account</Text></Text>
                    </View>
                </ScrollView>
            </View>
           </>
